...
class Recent_Posts_With_Thumb extends WP_Widget {
	...
	{
		$widget_ops = array( 'classname' => 'Recent_Posts_With_Thumb', 'description' => __('Show Recent or Popular or Random posts from your blog with thumbnails.','framework') );
		$this->WP_Widget( 'Recent_Posts_With_Thumb', __('Elegantia: Recent Posts With Thumbnail','framework'), $widget_ops );
	}
